...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference("Text.count") do
      post texts_url, params: { text: { notes: @text.notes, title_phonetics: @text.title_phonetics, title_tibetan: @text.title_tibetan } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { notes: @text.notes, title_phonetics: @text.title_phonetics, title_tibetan: @text.title_tibetan } }
