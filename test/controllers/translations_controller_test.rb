...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference("Translation.count") do
      post translations_url, params: { translation: { language: @translation.language, text_id: @translation.text_id } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { language: @translation.language, text_id: @translation.text_id } }
