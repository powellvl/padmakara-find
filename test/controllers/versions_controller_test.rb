...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference("Version.count") do
      post versions_url, params: { version: { name: @version.name, status: @version.status, translation_id: @version.translation_id } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { name: @version.name, status: @version.status, translation_id: @version.translation_id } }
